...
func TestAccAWSGameliftFleet_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAWSGameliftFleetBasicConfig(fleetName, launchPath, buildName, bucketName, key, roleArn),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "ec2_instance_type", "t2.small"),
			...
			{
				Config: testAccAWSGameliftFleetBasicUpdatedConfig(desc, uFleetName, launchPath, buildName, bucketName, key, roleArn),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSGameliftFleetExists("aws_gamelift_fleet.test", &conf),
					resource.TestCheckResourceAttrSet("aws_gamelift_fleet.test", "build_id"),
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "ec2_instance_type", "t2.small"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "runtime_configuration.0.server_process.0.launch_path", launchPath),
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "runtime_configuration.0.server_process.0.parameters", params),
					...
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "runtime_configuration.0.server_process.1.parameters", params),
					...
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "runtime_configuration.0.server_process.2.parameters", params),
				),
			},
			{
...
func testAccAWSGameliftFleetBasicConfig(fleetName, launchPath, buildName, bucketName, key, roleArn string) string {
	return fmt.Sprintf(`
...
%s
`, fleetName, launchPath, testAccAWSGameliftFleetBasicTemplate(buildName, bucketName, key, roleArn))
}

func testAccAWSGameliftFleetBasicUpdatedConfig(desc, fleetName, launchPath, buildName, bucketName, key, roleArn string) string {
	return fmt.Sprintf(`
resource "aws_gamelift_fleet" "test" {
  build_id = "${aws_gamelift_build.test.id}"
  ec2_instance_type = "t2.small"
...
%s
`, desc, fleetName, launchPath, testAccAWSGameliftFleetBasicTemplate(buildName, bucketName, key, roleArn))
}

func testAccAWSGameliftFleetAllFieldsConfig(fleetName, desc, launchPath, params, buildName, bucketName, key, roleArn string) string {
	return fmt.Sprintf(`
resource "aws_gamelift_fleet" "test" {
  build_id = "${aws_gamelift_build.test.id}"
  ec2_instance_type = "t2.small"
...
func testAccAWSGameliftFleetAllFieldsUpdatedConfig(fleetName, desc, launchPath, params, buildName, bucketName, key, roleArn string) string {
	return fmt.Sprintf(`
resource "aws_gamelift_fleet" "test" {
  build_id = "${aws_gamelift_build.test.id}"
  ec2_instance_type = "t2.small"
...
%s
`, fleetName, desc, launchPath, params, launchPath, params,
		testAccAWSGameliftFleetBasicTemplate(buildName, bucketName, key, roleArn))
}
